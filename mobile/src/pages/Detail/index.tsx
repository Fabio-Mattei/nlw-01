...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${('55' + String(data.point.whatsapp))}&text=Tenho interesse sobre coleta de resíduos`)
    }
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.address}>
                ...
                <Text style={styles.addressContent}>{data.point.city} {(data.point.city !== '' && data.point.uf !== '') ? ', ' : ''} {data.point.uf}</Text>
            </View>
        </View>        
